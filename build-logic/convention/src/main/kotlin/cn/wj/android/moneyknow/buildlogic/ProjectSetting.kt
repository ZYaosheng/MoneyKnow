...
object ProjectSetting {
    ...
    object Plugin {
        ...
        /** 自定义 仓库插件 */
        const val PLUGIN_CASHBOOK_LIBRARY = "moneyknow.android.library"

        /** 自定义 lint 插件 */
        const val PLUGIN_CASHBOOK_LINT = "moneyknow.android.lint"

        /** 自定义 hilt 依赖注入插件 */
        const val PLUGIN_CASHBOOK_HILT = "moneyknow.android.hilt"
    }
}

/** Android 仪器化测试 Runner */
const val TEST_INSTRUMENTATION_RUNNER = "cn.wj.android.moneyknow.core.testing.MoneyknowTestRunner"

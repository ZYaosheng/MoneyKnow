...
/** 数据库文件名 */
const val DB_FILE_NAME = "moneyknow.db"

/** 初始化默认数据库名 */
const val DB_INIT_FILE_NAME = "moneyknow_init.db"
...
/** 备份文件夹 */
const val BACKUP_DIR_NAME = "Moneyknow_Backup"

/** 备份缓存文件夹 */
const val BACKUP_CACHE_FILE_NAME = "Moneyknow_Backup_Cache"

/** 备份文件名 */
const val BACKUP_FILE_NAME = "Moneyknow_Backup_File_"
